    ...
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                ...
                nameTemplateText:  '<span></span><span class="fa fa-question-circle"></span> %name',
        ...
        plugin.method = {
            ...
            setupQuiz: function(options) { // use 'options' object to pass args
                ...
                $quizHeader.hide().prepend($('<div class="row"><div class="col-xs-10"><div class="quizDescription well">' + quizValues.info.main + '</div></div><div class="col-xs-2"><div class="well"><div id="countdown-11"></div><script src="/js/jquery.timeTo.js"></script><script>$("#countdown-11").timeTo({seconds: 100,displayHours: false});</script></div></div></div>')).fadeIn(1000, kN(key,2));
